...
const routes: Routes = [
    ...
    { path: 'retention',                     component: AdminRetentionComponent, canActivate: [AuthGuard],      data: { is_admin: true } },
    { path: 'maintenance_config',            component: AdminMaintenanceComponent, canActivate: [AuthGuard],    data: { is_admin: true } },
